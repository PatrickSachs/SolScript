...
namespace NesterovskyBros.Utils
{
    ...
    internal class WeakTable<K, V> : IEnumerable<KeyValuePair<K, V>>
        where K : class
    {
        /// <summary>
        ...
        public bool Remove(K key)
        {
            ...
            bool result = values.TryRemove(stateRef, out stateRef);
        ...
        {
            State state = new State(self, key, comparer.GetHashCode(key));
        ...
        private class State
        {
            ...
            ~State()
            {
                WeakTable<K, V> weakTable = Get(weakTableRef);
