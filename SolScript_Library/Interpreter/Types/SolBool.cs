...
namespace SolScript.Interpreter.Types {
    public class SolBool : SolValue {
        ...
        public override object ConvertTo(Type type) {
            ...
            throw new SolScriptMarshallingException("bool", type, "Cannot convert SolBool!");
        }
        ...
        public override SolValue And(SolExecutionContext context, SolValue other) {
            SolBool otherBool = other as SolBool;
            if (otherBool == null) {
                throw new SolScriptInterpreterException(context, "Cannot combine a bool and a " + other.Type + " via and.");
            }
        ...
        public override SolValue Or(SolExecutionContext context, SolValue other) {
            SolBool otherBool = other as SolBool;
            if (otherBool == null) {
                throw new SolScriptInterpreterException(context, "Cannot or switch a bool and a " + other.Type + " via and.");
            }
            return new SolBool(Value || otherBool.Value);
        }
