...
namespace SolScript.Interpreter {
    ...
    public interface IVariables {
        ...
        VariableGet TryGet(string name, out SolValue value);
        ...
        void Declare(string name, SolType type);
        ...
        void DeclareNative(string name, SolType type, [NotNull] InspectorField field, [NotNull] DynamicReference fieldReference);
        ...
        void AssignAnnotations(string name, params SolClass[] annotations);
        ...
        void Assign(string name, SolValue value);
